...
class SliverGridDelegateWithFixedCross extends SliverGridDelegate {
  ...
  const SliverGridDelegateWithFixedCross({
  ...
  @override
  bool shouldRelayout(SliverGridDelegateWithFixedCross oldDelegate) {
